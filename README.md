...
17.  Activation functions:
    ...
    - One of the most popular activation functions: **ReLU = $max(0,z)$**
        ...
        - One disadvantage of ReLU is that its derivative is 0 for -ve $z$, leading to the **dying ReLU problem** and to almost stationary GD i.e., no update of weights and such a dead ReLU outputs only 0. In practice, this still works fine.
